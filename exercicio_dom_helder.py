# Faça um programa para calcular e imprimir o valor a ser descontado de INSS
# no salário
...
emitidos
por uma empresa. Dependendo do valor obtido, a empresa foi multada conforme a
tabela abaixo.
Faça um programa que leia a quantidade de poluentes emitidos por uma empresa e
calcule e imprima
...
"""
Exercicio-4
Faça um programa que calcule o salário mensal a receber de um vendedor
comissionado.
O salário é constituído de um valor fixo de R$240,00 mais o valor referente a
comissão,
calculada de acordo com a tabela abaixo, que varia com as vendas mensais
realizadas pelo vendedor.
O programa deverá solicitar ao usuário o valor mensal das vendas do vendedor e
calcular e imprimir
...
Faça um programa para ler o nome, a altura (em metros) e o peso (em kg)
de uma pessoa
e informar a ela a sua situação corporal de acordo com o seu IMC
...
"""
Exercicio- 6
Faça um programa que solicite ao usuário um número inteiro e calcule e imprima
se ele é divisível ao mesmo tempo por 5 e 7.

Observação: Para testarmos se um número é divisível por outro utilizamos o
operador % (RESTO DE UMA DIVISÃO INTEIRA).
...
"""
Exercicio-7
Pela fórmula de Báskara abaixo calculamos as raízes reais de uma equação do
segundo grau.
...
da faixa de peso ideal de acordo com a tabela de IMC (Índice de Massa Corporal)
abaixo.
...
(“F” para feminino e “M” para masculino), faça um programa que calcule o peso
ideal
...
a financeira calcula o valor a ser resgatado levando-se em conta o número de
dias
que o dinheiro ficou aplicado, a taxa de juros diária, uma taxa de
administração de
R$10,00 e o valor a ser retido na fonte de imposto de renda (percentual de 15%)

Faça um programa que calcule o valor resgatado, solicitando ao usuário o
capital aplicado,
o número de dias que ficou aplicado e a taxa diária e calcule e imprime o
rendimento,
